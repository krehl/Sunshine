...
import de.kkrehl.udacity.sunshine.data.WeatherDbHelper;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Weather entry does not match.", cursor, contentValues);
    ...
    public long insertLocation() {
        ...
        // Insert ContentValues into database and get a row ID back
        long row = sqLiteDatabase.insert(WeatherContract.LocationEntry.TABLE_NAME, null, contentValues);
        assertNotSame("Could not insert record.", -1, row);
        // Query the database and receive a Cursor back
